...
vim.keymap.set(
	...
	{ desc = "Open new terminal", noremap = true, silent = true }
)
...
vim.keymap.set(
	...
	"<ESC>",
	"<C-\\><C-n>",
	{ desc = "Exit out of insert mode in terminal", noremap = true, silent = true }
)
...
end, { desc = "Formatfile or range (in visual mode)" })
